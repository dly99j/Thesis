...
namespace spsh {
    ...
    namespace constants {
        constexpr player_details firts_ship{1000.0f, 3, 10, 2000.0f, 2.0f, 10.0f, map::first};
        constexpr player_details second_ship{1000.0f, 5, 20, 1500.0f, 2.0f, 10.0f, map::second};
        constexpr player_details third_ship{800.0f, 7, 5, 2500.0f, 5.0f, 1.0f, map::third};
