...
namespace spsh {
    ...
    auto waypoint_enemy::generate_new_waypoint(const sf::Vector2u t_screen_dimensions) -> void {
    ...
    auto waypoint_enemy::calculate_direction(const sf::Vector2u t_screen_dimensions,
