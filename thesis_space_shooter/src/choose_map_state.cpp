...
namespace spsh {
choose_map_state::choose_map_state(sf::RenderWindow& t_window)
    : menu_base(t_window),
...
auto choose_map_state::display() -> std::optional<map> {
    ...
    m_map0_button.setPosition(
        (static_cast<float>(m_window.getSize().x) - m_map0_button.getSize().x) /
            2.f,
        180.f);
    m_map1_button.setPosition(
        (static_cast<float>(m_window.getSize().x) - m_map1_button.getSize().x) /
            2.f,
        440.f);
    m_map2_button.setPosition(
        (static_cast<float>(m_window.getSize().x) - m_map2_button.getSize().x) /
            2.f,
        700.f);
    ...
    map0_text.setPosition(
        m_map0_button.getPosition().x +
            (m_map0_button.getSize().x - map0_text.getGlobalBounds().width) /
                2.f,
        m_map0_button.getPosition().y +
            (m_map0_button.getSize().y - map0_text.getGlobalBounds().height) /
                2.f -
            5.f);
    ...
    map1_text.setPosition(
        m_map1_button.getPosition().x +
            (m_map1_button.getSize().x - map1_text.getGlobalBounds().width) /
                2.f,
        m_map1_button.getPosition().y +
            (m_map1_button.getSize().y - map1_text.getGlobalBounds().height) /
                2.f -
            5.f);
    ...
    map2_text.setPosition(
        m_map2_button.getPosition().x +
            (m_map2_button.getSize().x - map2_text.getGlobalBounds().width) /
                2.f,
        m_map2_button.getPosition().y +
            (m_map2_button.getSize().y - map2_text.getGlobalBounds().height) /
                2.f -
            5.f);
